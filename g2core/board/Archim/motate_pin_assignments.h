...
// Archim extra pins
_MAKE_MOTATE_PIN(92, 'C', 11);  // D92

_MAKE_MOTATE_PIN(96, 'C', 10);  // D96

_MAKE_MOTATE_PIN(97, 'B', 24);  // D97

_MAKE_MOTATE_PIN(104, 'C', 20);  // D104

_MAKE_MOTATE_PIN(105, 'B', 22);  // D105

_MAKE_MOTATE_PIN(106, 'C', 27);  // D106

_MAKE_MOTATE_PIN(107, 'B', 10);  // D107
