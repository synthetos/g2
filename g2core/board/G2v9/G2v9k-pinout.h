...
//_MAKE_MOTATE_PIN(kOutput3_PinNumber, 'A', 5);                 // Spindle_EnablePinNumber --used for Fan 1 in g2ref
...
//_MAKE_MOTATE_PIN(kOutput1_PinNumber, 'A', 8);                 // Spindle_PwmPinNumber -- used for Extruder 1 in g2ref
