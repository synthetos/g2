...
//  { "jog","jogc",_f0, 0, tx_print_nul, get_nul, cm_run_jogc, (float *)&cm.jogging_dest, 0},
    ...
    { "1","1mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_1].microsteps,     M1_MICROSTEPS },
...
//  { "1","1mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_1].motor_timeout,  M1_MOTOR_TIMEOUT },
    ...
    { "1","1ts",_f0,  0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_ts(nv); },
        set_ro, (float *)&cs.null, 0 },
    { "1","1pth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_pth(nv);},
        [](nvObj_t *nv){return motor_1.set_pth(nv);}, (float *)&cs.null, M1_TMC2130_TPWMTHRS },
    { "1","1cth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_cth(nv);},
        [](nvObj_t *nv){return motor_1.set_cth(nv);}, (float *)&cs.null, M1_TMC2130_TCOOLTHRS },
    { "1","1hth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_hth(nv);},
        [](nvObj_t *nv){return motor_1.set_hth(nv);}, (float *)&cs.null, M1_TMC2130_THIGH },
    { "1","1sgt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_sgt(nv);},
        [](nvObj_t *nv){return motor_1.set_sgt(nv);}, (float *)&cs.null, M1_TMC2130_SGT },
    { "1","1sgr",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_sgr(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "1","1csa",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_csa(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "1","1sgs",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_sgs(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "1","1tbl",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_tbl(nv);},
        [](nvObj_t *nv){return motor_1.set_tbl(nv);}, (float *)&cs.null, M1_TMC2130_TBL },
    { "1","1pgrd",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_pgrd(nv);},
        [](nvObj_t *nv){return motor_1.set_pgrd(nv);}, (float *)&cs.null, M1_TMC2130_PWM_GRAD },
    { "1","1pamp",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_pamp(nv);},
        [](nvObj_t *nv){return motor_1.set_pamp(nv);}, (float *)&cs.null, M1_TMC2130_PWM_AMPL },
    { "1","1hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_hend(nv);},
        [](nvObj_t *nv){return motor_1.set_hend(nv);}, (float *)&cs.null, M1_TMC2130_HEND },
    { "1","1hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_1.set_hsrt(nv);}, (float *)&cs.null, M1_TMC2130_HSTRT },
    { "1","1smin",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_smin(nv);},
        [](nvObj_t *nv){return motor_1.set_smin(nv);}, (float *)&cs.null, M1_TMC2130_SMIN },
    { "1","1smax",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_smax(nv);},
        [](nvObj_t *nv){return motor_1.set_smax(nv);}, (float *)&cs.null, M1_TMC2130_SMAX },
    { "1","1sup",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_sup(nv);},
        [](nvObj_t *nv){return motor_1.set_sup(nv);}, (float *)&cs.null, M1_TMC2130_SUP },
    { "1","1sdn",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_1.get_sdn(nv);},
        [](nvObj_t *nv){return motor_1.set_sdn(nv);}, (float *)&cs.null, M1_TMC2130_SDN },
#endif
    ...
    { "2","2mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_2].microsteps,     M2_MICROSTEPS },
...
//  { "2","2mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_2].motor_timeout,  M2_MOTOR_TIMEOUT },
    ...
    { "2","2ts",_f0,  0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_ts(nv); },
        set_ro, (float *)&cs.null, 0 },
    { "2","2pth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_pth(nv);},
        [](nvObj_t *nv){return motor_2.set_pth(nv);}, (float *)&cs.null, M2_TMC2130_TPWMTHRS },
    { "2","2cth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_cth(nv);},
        [](nvObj_t *nv){return motor_2.set_cth(nv);}, (float *)&cs.null, M2_TMC2130_TCOOLTHRS },
    { "2","2hth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_hth(nv);},
        [](nvObj_t *nv){return motor_2.set_hth(nv);}, (float *)&cs.null, M2_TMC2130_THIGH },
    { "2","2sgt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_sgt(nv);},
        [](nvObj_t *nv){return motor_2.set_sgt(nv);}, (float *)&cs.null, M2_TMC2130_SGT },
    { "2","2sgr",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_sgr(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "2","2csa",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_csa(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "2","2sgs",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_sgs(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "2","2tbl",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_tbl(nv);},
        [](nvObj_t *nv){return motor_2.set_tbl(nv);}, (float *)&cs.null, M2_TMC2130_TBL },
    { "2","2pgrd",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_pgrd(nv);},
        [](nvObj_t *nv){return motor_2.set_pgrd(nv);}, (float *)&cs.null, M2_TMC2130_PWM_GRAD },
    { "1","2pamp",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_pamp(nv);},
        [](nvObj_t *nv){return motor_2.set_pamp(nv);}, (float *)&cs.null, M2_TMC2130_PWM_AMPL },
    { "2","2hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_hend(nv);},
        [](nvObj_t *nv){return motor_2.set_hend(nv);}, (float *)&cs.null, M2_TMC2130_HEND },
    { "2","2hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_2.set_hsrt(nv);}, (float *)&cs.null, M2_TMC2130_HSTRT },
    { "2","2smin",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_smin(nv);},
        [](nvObj_t *nv){return motor_2.set_smin(nv);}, (float *)&cs.null, M2_TMC2130_SMIN },
    { "2","2smax",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_smax(nv);},
        [](nvObj_t *nv){return motor_2.set_smax(nv);}, (float *)&cs.null, M2_TMC2130_SMAX },
    { "2","2sup",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_sup(nv);},
        [](nvObj_t *nv){return motor_2.set_sup(nv);}, (float *)&cs.null, M2_TMC2130_SUP },
    { "2","2sdn",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_2.get_sdn(nv);},
        [](nvObj_t *nv){return motor_2.set_sdn(nv);}, (float *)&cs.null, M2_TMC2130_SDN },
#endif
#endif
#if (MOTORS >= 3)
    ...
    { "3","3mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_3].microsteps,     M3_MICROSTEPS },
...
//  { "3","3mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_3].motor_timeout,  M3_MOTOR_TIMEOUT },
    ...
    { "3","3ts",_f0,  0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_ts(nv); },
        set_ro, (float *)&cs.null, 0 },
    { "3","3pth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_pth(nv);},
        [](nvObj_t *nv){return motor_3.set_pth(nv);}, (float *)&cs.null, M3_TMC2130_TPWMTHRS },
    { "3","3cth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_cth(nv);},
        [](nvObj_t *nv){return motor_3.set_cth(nv);}, (float *)&cs.null, M3_TMC2130_TCOOLTHRS },
    { "3","3hth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_hth(nv);},
        [](nvObj_t *nv){return motor_3.set_hth(nv);}, (float *)&cs.null, M3_TMC2130_THIGH },
    { "3","3sgt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_sgt(nv);},
        [](nvObj_t *nv){return motor_3.set_sgt(nv);}, (float *)&cs.null, M3_TMC2130_SGT },
    { "3","3sgr",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_sgr(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "3","3csa",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_csa(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "3","3sgs",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_sgs(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "3","3tbl",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_tbl(nv);},
        [](nvObj_t *nv){return motor_3.set_tbl(nv);}, (float *)&cs.null, M3_TMC2130_TBL },
    { "3","3pgrd",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_pgrd(nv);},
        [](nvObj_t *nv){return motor_3.set_pgrd(nv);}, (float *)&cs.null, M3_TMC2130_PWM_GRAD },
    { "1","3pamp",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_pamp(nv);},
        [](nvObj_t *nv){return motor_3.set_pamp(nv);}, (float *)&cs.null, M3_TMC2130_PWM_AMPL },
    { "3","3hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_hend(nv);},
        [](nvObj_t *nv){return motor_3.set_hend(nv);}, (float *)&cs.null, M3_TMC2130_HEND },
    { "3","3hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_3.set_hsrt(nv);}, (float *)&cs.null, M3_TMC2130_HSTRT },
    { "3","3smin",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_smin(nv);},
        [](nvObj_t *nv){return motor_3.set_smin(nv);}, (float *)&cs.null, M3_TMC2130_SMIN },
    { "3","3smax",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_smax(nv);},
        [](nvObj_t *nv){return motor_3.set_smax(nv);}, (float *)&cs.null, M3_TMC2130_SMAX },
    { "3","3sup",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_sup(nv);},
        [](nvObj_t *nv){return motor_3.set_sup(nv);}, (float *)&cs.null, M3_TMC2130_SUP },
    { "3","3sdn",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_3.get_sdn(nv);},
        [](nvObj_t *nv){return motor_3.set_sdn(nv);}, (float *)&cs.null, M3_TMC2130_SDN },
#endif
#endif
#if (MOTORS >= 4)
    ...
    { "4","4mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_4].microsteps,     M4_MICROSTEPS },
...
//  { "4","4mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_4].motor_timeout,  M4_MOTOR_TIMEOUT },
    ...
    { "4","4ts",_f0,  0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_ts(nv); },
        set_ro, (float *)&cs.null, 0 },
    { "4","4pth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_pth(nv);},
        [](nvObj_t *nv){return motor_4.set_pth(nv);}, (float *)&cs.null, M4_TMC2130_TPWMTHRS },
    { "4","4cth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_cth(nv);},
        [](nvObj_t *nv){return motor_4.set_cth(nv);}, (float *)&cs.null, M4_TMC2130_TCOOLTHRS },
    { "4","4hth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_hth(nv);},
        [](nvObj_t *nv){return motor_4.set_hth(nv);}, (float *)&cs.null, M4_TMC2130_THIGH },
    { "4","4sgt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_sgt(nv);},
        [](nvObj_t *nv){return motor_4.set_sgt(nv);}, (float *)&cs.null, M4_TMC2130_SGT },
    { "4","4sgr",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_sgr(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "4","4csa",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_csa(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "4","4sgs",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_sgs(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "4","4tbl",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_tbl(nv);},
        [](nvObj_t *nv){return motor_4.set_tbl(nv);}, (float *)&cs.null, M4_TMC2130_TBL },
    { "4","4pgrd",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_pgrd(nv);},
        [](nvObj_t *nv){return motor_4.set_pgrd(nv);}, (float *)&cs.null, M4_TMC2130_PWM_GRAD },
    { "1","4pamp",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_pamp(nv);},
        [](nvObj_t *nv){return motor_4.set_pamp(nv);}, (float *)&cs.null, M4_TMC2130_PWM_AMPL },
    { "4","4hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_hend(nv);},
        [](nvObj_t *nv){return motor_4.set_hend(nv);}, (float *)&cs.null, M4_TMC2130_HEND },
    { "4","4hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_4.set_hsrt(nv);}, (float *)&cs.null, M4_TMC2130_HSTRT },
    { "4","4hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_hend(nv);},
        [](nvObj_t *nv){return motor_4.set_hend(nv);}, (float *)&cs.null, M4_TMC2130_HEND },
    { "4","4hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_4.set_hsrt(nv);}, (float *)&cs.null, M4_TMC2130_HSTRT },
    { "4","4smin",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_smin(nv);},
        [](nvObj_t *nv){return motor_4.set_smin(nv);}, (float *)&cs.null, M4_TMC2130_SMIN },
    { "4","4smax",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_smax(nv);},
        [](nvObj_t *nv){return motor_4.set_smax(nv);}, (float *)&cs.null, M4_TMC2130_SMAX },
    { "4","4sup",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_sup(nv);},
        [](nvObj_t *nv){return motor_4.set_sup(nv);}, (float *)&cs.null, M4_TMC2130_SUP },
    { "4","4sdn",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_4.get_sdn(nv);},
        [](nvObj_t *nv){return motor_4.set_sdn(nv);}, (float *)&cs.null, M4_TMC2130_SDN },
#endif
#endif
#if (MOTORS >= 5)
    ...
    { "5","5mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_5].microsteps,     M5_MICROSTEPS },
...
//  { "5","5mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_5].motor_timeout,  M5_MOTOR_TIMEOUT },
    ...
    { "5","5ts",_f0,  0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_ts(nv); },
        set_ro, (float *)&cs.null, 0 },
    { "5","5pth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_pth(nv);},
        [](nvObj_t *nv){return motor_5.set_pth(nv);}, (float *)&cs.null, M5_TMC2130_TPWMTHRS },
    { "5","5cth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_cth(nv);},
        [](nvObj_t *nv){return motor_5.set_cth(nv);}, (float *)&cs.null, M5_TMC2130_TCOOLTHRS },
    { "5","5hth",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_hth(nv);},
        [](nvObj_t *nv){return motor_5.set_hth(nv);}, (float *)&cs.null, M5_TMC2130_THIGH },
    { "5","5sgt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_sgt(nv);},
        [](nvObj_t *nv){return motor_5.set_sgt(nv);}, (float *)&cs.null, M5_TMC2130_SGT },
    { "5","5sgr",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_sgr(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "5","5csa",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_csa(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "5","5sgs",_f0, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_sgs(nv);},
        set_ro, (float *)&cs.null, 0 },
    { "5","5tbl",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_tbl(nv);},
        [](nvObj_t *nv){return motor_5.set_tbl(nv);}, (float *)&cs.null, M5_TMC2130_TBL },
    { "5","5pgrd",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_pgrd(nv);},
        [](nvObj_t *nv){return motor_5.set_pgrd(nv);}, (float *)&cs.null, M5_TMC2130_PWM_GRAD },
    { "5","5pamp",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_pamp(nv);},
        [](nvObj_t *nv){return motor_5.set_pamp(nv);}, (float *)&cs.null, M5_TMC2130_PWM_AMPL },
    { "5","5hend",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_hend(nv);},
        [](nvObj_t *nv){return motor_5.set_hend(nv);}, (float *)&cs.null, M5_TMC2130_HEND },
    { "5","5hsrt",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_hsrt(nv);},
        [](nvObj_t *nv){return motor_5.set_hsrt(nv);}, (float *)&cs.null, M5_TMC2130_HSTRT },
    { "5","5smin",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_smin(nv);},
        [](nvObj_t *nv){return motor_5.set_smin(nv);}, (float *)&cs.null, M5_TMC2130_SMIN },
    { "5","5smax",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_smax(nv);},
        [](nvObj_t *nv){return motor_5.set_smax(nv);}, (float *)&cs.null, M5_TMC2130_SMAX },
    { "5","5sup",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_sup(nv);},
        [](nvObj_t *nv){return motor_5.set_sup(nv);}, (float *)&cs.null, M5_TMC2130_SUP },
    { "5","5sdn",_fip, 0, tx_print_nul,
        [](nvObj_t *nv){return motor_5.get_sdn(nv);},
        [](nvObj_t *nv){return motor_5.set_sdn(nv);}, (float *)&cs.null, M5_TMC2130_SDN },
#endif
#endif
#if (MOTORS >= 6)
    ...
    { "6","6mi",_fip, 0, st_print_mi, get_int, st_set_mi,  (float *)&st_cfg.mot[MOTOR_6].microsteps,     M6_MICROSTEPS },
...
//  { "6","6mt",_fip, 2, st_print_mt, get_flt, st_set_mt,  (float *)&st_cfg.mot[MOTOR_6].motor_timeout,  M6_MOTOR_TIMEOUT },
    ...
    { "he1","he1tv",_f0,  6, tx_print_nul, cm_get_thermistor_voltage, set_ro,              (float *)&cs.null, 0 },
    ...
    { "he2","he2tv",_f0,  6, tx_print_nul, cm_get_thermistor_voltage, set_ro,              (float *)&cs.null, 0 },
    ...
    { "he3","he3tv",_f0,  6, tx_print_nul, cm_get_thermistor_voltage, set_ro,              (float *)&cs.null, 0 },
