...
//  { "jog","jogc",_f0, 0, tx_print_nul, get_nul, cm_run_jogc, (float *)&cm.jogging_dest, 0},
    ...
    { "1","1ts",  _f0,  0, tx_print_nul, motor_1.get_ts_fn,  set_ro,              (float *)&motor_1, 0 },
    { "1","1pth", _fip, 0, tx_print_nul, motor_1.get_pth_fn, motor_1.set_pth_fn,  (float *)&motor_1, M1_TMC2130_TPWMTHRS },
    { "1","1cth", _fip, 0, tx_print_nul, motor_1.get_cth_fn, motor_1.set_cth_fn,  (float *)&motor_1, M1_TMC2130_TCOOLTHRS },
    { "1","1hth", _fip, 0, tx_print_nul, motor_1.get_hth_fn, motor_1.set_hth_fn,  (float *)&motor_1, M1_TMC2130_THIGH },
    { "1","1sgt", _fip, 0, tx_print_nul, motor_1.get_sgt_fn, motor_1.set_sgt_fn,  (float *)&motor_1, M1_TMC2130_SGT },
    { "1","1sgr", _f0,  0, tx_print_nul, motor_1.get_sgr_fn, set_ro,              (float *)&motor_1, 0 },
    { "1","1csa", _f0,  0, tx_print_nul, motor_1.get_csa_fn, set_ro,              (float *)&motor_1, 0 },
    { "1","1sgs", _f0,  0, tx_print_nul, motor_1.get_sgs_fn, set_ro,              (float *)&motor_1, 0 },
    { "1","1tbl", _fip, 0, tx_print_nul, motor_1.get_tbl_fn, motor_1.set_tbl_fn,  (float *)&motor_1, M1_TMC2130_TBL },
    { "1","1pgrd",_fip, 0, tx_print_nul, motor_1.get_pgrd_fn,motor_1.set_pgrd_fn, (float *)&motor_1, M1_TMC2130_PWM_GRAD },
    { "1","1pamp",_fip, 0, tx_print_nul, motor_1.get_pamp_fn,motor_1.set_pamp_fn, (float *)&motor_1, M1_TMC2130_PWM_AMPL },
    { "1","1hend",_fip, 0, tx_print_nul, motor_1.get_hend_fn,motor_1.set_hend_fn, (float *)&motor_1, M1_TMC2130_HEND },
    { "1","1hsrt",_fip, 0, tx_print_nul, motor_1.get_hsrt_fn,motor_1.set_hsrt_fn, (float *)&motor_1, M1_TMC2130_HSTRT },
    { "1","1smin",_fip, 0, tx_print_nul, motor_1.get_smin_fn,motor_1.set_smin_fn, (float *)&motor_1, M1_TMC2130_SMIN },
    { "1","1smax",_fip, 0, tx_print_nul, motor_1.get_smax_fn,motor_1.set_smax_fn, (float *)&motor_1, M1_TMC2130_SMAX },
    { "1","1sup", _fip, 0, tx_print_nul, motor_1.get_sup_fn, motor_1.set_sup_fn,  (float *)&motor_1, M1_TMC2130_SUP },
    { "1","1sdn", _fip, 0, tx_print_nul, motor_1.get_sdn_fn, motor_1.set_sdn_fn,  (float *)&motor_1, M1_TMC2130_SDN },
#endif
#endif
    ...
    { "2","2ts",  _f0,  0, tx_print_nul, motor_2.get_ts_fn,  set_ro,              (float *)&motor_2, 0 },
    { "2","2pth", _fip, 0, tx_print_nul, motor_2.get_pth_fn, motor_2.set_pth_fn,  (float *)&motor_2, M2_TMC2130_TPWMTHRS },
    { "2","2cth", _fip, 0, tx_print_nul, motor_2.get_cth_fn, motor_2.set_cth_fn,  (float *)&motor_2, M2_TMC2130_TCOOLTHRS },
    { "2","2hth", _fip, 0, tx_print_nul, motor_2.get_hth_fn, motor_2.set_hth_fn,  (float *)&motor_2, M2_TMC2130_THIGH },
    { "2","2sgt", _fip, 0, tx_print_nul, motor_2.get_sgt_fn, motor_2.set_sgt_fn,  (float *)&motor_2, M2_TMC2130_SGT },
    { "2","2sgr", _f0,  0, tx_print_nul, motor_2.get_sgr_fn, set_ro,              (float *)&motor_2, 0 },
    { "2","2csa", _f0,  0, tx_print_nul, motor_2.get_csa_fn, set_ro,              (float *)&motor_2, 0 },
    { "2","2sgs", _f0,  0, tx_print_nul, motor_2.get_sgs_fn, set_ro,              (float *)&motor_2, 0 },
    { "2","2tbl", _fip, 0, tx_print_nul, motor_2.get_tbl_fn, motor_2.set_tbl_fn,  (float *)&motor_2, M2_TMC2130_TBL },
    { "2","2pgrd",_fip, 0, tx_print_nul, motor_2.get_pgrd_fn,motor_2.set_pgrd_fn, (float *)&motor_2, M2_TMC2130_PWM_GRAD },
    { "2","2pamp",_fip, 0, tx_print_nul, motor_2.get_pamp_fn,motor_2.set_pamp_fn, (float *)&motor_2, M2_TMC2130_PWM_AMPL },
    { "2","2hend",_fip, 0, tx_print_nul, motor_2.get_hend_fn,motor_2.set_hend_fn, (float *)&motor_2, M2_TMC2130_HEND },
    { "2","2hsrt",_fip, 0, tx_print_nul, motor_2.get_hsrt_fn,motor_2.set_hsrt_fn, (float *)&motor_2, M2_TMC2130_HSTRT },
    { "2","2smin",_fip, 0, tx_print_nul, motor_2.get_smin_fn,motor_2.set_smin_fn, (float *)&motor_2, M2_TMC2130_SMIN },
    { "2","2smax",_fip, 0, tx_print_nul, motor_2.get_smax_fn,motor_2.set_smax_fn, (float *)&motor_2, M2_TMC2130_SMAX },
    { "2","2sup", _fip, 0, tx_print_nul, motor_2.get_sup_fn, motor_2.set_sup_fn,  (float *)&motor_2, M2_TMC2130_SUP },
    { "2","2sdn", _fip, 0, tx_print_nul, motor_2.get_sdn_fn, motor_2.set_sdn_fn,  (float *)&motor_2, M2_TMC2130_SDN },
#endif
#endif
    ...
    { "3","3ts",  _f0,  0, tx_print_nul, motor_3.get_ts_fn,  set_ro,              (float *)&motor_3, 0 },
    { "3","3pth", _fip, 0, tx_print_nul, motor_3.get_pth_fn, motor_3.set_pth_fn,  (float *)&motor_3, M3_TMC2130_TPWMTHRS },
    { "3","3cth", _fip, 0, tx_print_nul, motor_3.get_cth_fn, motor_3.set_cth_fn,  (float *)&motor_3, M3_TMC2130_TCOOLTHRS },
    { "3","3hth", _fip, 0, tx_print_nul, motor_3.get_hth_fn, motor_3.set_hth_fn,  (float *)&motor_3, M3_TMC2130_THIGH },
    { "3","3sgt", _fip, 0, tx_print_nul, motor_3.get_sgt_fn, motor_3.set_sgt_fn,  (float *)&motor_3, M3_TMC2130_SGT },
    { "3","3sgr", _f0,  0, tx_print_nul, motor_3.get_sgr_fn, set_ro,              (float *)&motor_3, 0 },
    { "3","3csa", _f0,  0, tx_print_nul, motor_3.get_csa_fn, set_ro,              (float *)&motor_3, 0 },
    { "3","3sgs", _f0,  0, tx_print_nul, motor_3.get_sgs_fn, set_ro,              (float *)&motor_3, 0 },
    { "3","3tbl", _fip, 0, tx_print_nul, motor_3.get_tbl_fn, motor_3.set_tbl_fn,  (float *)&motor_3, M3_TMC2130_TBL },
    { "3","3pgrd",_fip, 0, tx_print_nul, motor_3.get_pgrd_fn,motor_3.set_pgrd_fn, (float *)&motor_3, M3_TMC2130_PWM_GRAD },
    { "3","3pamp",_fip, 0, tx_print_nul, motor_3.get_pamp_fn,motor_3.set_pamp_fn, (float *)&motor_3, M3_TMC2130_PWM_AMPL },
    { "3","3hend",_fip, 0, tx_print_nul, motor_3.get_hend_fn,motor_3.set_hend_fn, (float *)&motor_3, M3_TMC2130_HEND },
    { "3","3hsrt",_fip, 0, tx_print_nul, motor_3.get_hsrt_fn,motor_3.set_hsrt_fn, (float *)&motor_3, M3_TMC2130_HSTRT },
    { "3","3smin",_fip, 0, tx_print_nul, motor_3.get_smin_fn,motor_3.set_smin_fn, (float *)&motor_3, M3_TMC2130_SMIN },
    { "3","3smax",_fip, 0, tx_print_nul, motor_3.get_smax_fn,motor_3.set_smax_fn, (float *)&motor_3, M3_TMC2130_SMAX },
    { "3","3sup", _fip, 0, tx_print_nul, motor_3.get_sup_fn, motor_3.set_sup_fn,  (float *)&motor_3, M3_TMC2130_SUP },
    { "3","3sdn", _fip, 0, tx_print_nul, motor_3.get_sdn_fn, motor_3.set_sdn_fn,  (float *)&motor_3, M3_TMC2130_SDN },
#endif
#endif
    ...
    { "4","4ts",  _f0,  0, tx_print_nul, motor_4.get_ts_fn,  set_ro,              (float *)&motor_4, 0 },
    { "4","4pth", _fip, 0, tx_print_nul, motor_4.get_pth_fn, motor_4.set_pth_fn,  (float *)&motor_4, M4_TMC2130_TPWMTHRS },
    { "4","4cth", _fip, 0, tx_print_nul, motor_4.get_cth_fn, motor_4.set_cth_fn,  (float *)&motor_4, M4_TMC2130_TCOOLTHRS },
    { "4","4hth", _fip, 0, tx_print_nul, motor_4.get_hth_fn, motor_4.set_hth_fn,  (float *)&motor_4, M4_TMC2130_THIGH },
    { "4","4sgt", _fip, 0, tx_print_nul, motor_4.get_sgt_fn, motor_4.set_sgt_fn,  (float *)&motor_4, M4_TMC2130_SGT },
    { "4","4sgr", _f0,  0, tx_print_nul, motor_4.get_sgr_fn, set_ro,              (float *)&motor_4, 0 },
    { "4","4csa", _f0,  0, tx_print_nul, motor_4.get_csa_fn, set_ro,              (float *)&motor_4, 0 },
    { "4","4sgs", _f0,  0, tx_print_nul, motor_4.get_sgs_fn, set_ro,              (float *)&motor_4, 0 },
    { "4","4tbl", _fip, 0, tx_print_nul, motor_4.get_tbl_fn, motor_4.set_tbl_fn,  (float *)&motor_4, M4_TMC2130_TBL },
    { "4","4pgrd",_fip, 0, tx_print_nul, motor_4.get_pgrd_fn,motor_4.set_pgrd_fn, (float *)&motor_4, M4_TMC2130_PWM_GRAD },
    { "4","4pamp",_fip, 0, tx_print_nul, motor_4.get_pamp_fn,motor_4.set_pamp_fn, (float *)&motor_4, M4_TMC2130_PWM_AMPL },
    { "4","4hend",_fip, 0, tx_print_nul, motor_4.get_hend_fn,motor_4.set_hend_fn, (float *)&motor_4, M4_TMC2130_HEND },
    { "4","4hsrt",_fip, 0, tx_print_nul, motor_4.get_hsrt_fn,motor_4.set_hsrt_fn, (float *)&motor_4, M4_TMC2130_HSTRT },
    { "4","4smin",_fip, 0, tx_print_nul, motor_4.get_smin_fn,motor_4.set_smin_fn, (float *)&motor_4, M4_TMC2130_SMIN },
    { "4","4smax",_fip, 0, tx_print_nul, motor_4.get_smax_fn,motor_4.set_smax_fn, (float *)&motor_4, M4_TMC2130_SMAX },
    { "4","4sup", _fip, 0, tx_print_nul, motor_4.get_sup_fn, motor_4.set_sup_fn,  (float *)&motor_4, M4_TMC2130_SUP },
    { "4","4sdn", _fip, 0, tx_print_nul, motor_4.get_sdn_fn, motor_4.set_sdn_fn,  (float *)&motor_4, M4_TMC2130_SDN },
#endif
#endif
    ...
    { "5","5ts",  _f0,  0, tx_print_nul, motor_5.get_ts_fn,  set_ro,              (float *)&motor_5, 0 },
    { "5","5pth", _fip, 0, tx_print_nul, motor_5.get_pth_fn, motor_5.set_pth_fn,  (float *)&motor_5, M5_TMC2130_TPWMTHRS },
    { "5","5cth", _fip, 0, tx_print_nul, motor_5.get_cth_fn, motor_5.set_cth_fn,  (float *)&motor_5, M5_TMC2130_TCOOLTHRS },
    { "5","5hth", _fip, 0, tx_print_nul, motor_5.get_hth_fn, motor_5.set_hth_fn,  (float *)&motor_5, M5_TMC2130_THIGH },
    { "5","5sgt", _fip, 0, tx_print_nul, motor_5.get_sgt_fn, motor_5.set_sgt_fn,  (float *)&motor_5, M5_TMC2130_SGT },
    { "5","5sgr", _f0,  0, tx_print_nul, motor_5.get_sgr_fn, set_ro,              (float *)&motor_5, 0 },
    { "5","5csa", _f0,  0, tx_print_nul, motor_5.get_csa_fn, set_ro,              (float *)&motor_5, 0 },
    { "5","5sgs", _f0,  0, tx_print_nul, motor_5.get_sgs_fn, set_ro,              (float *)&motor_5, 0 },
    { "5","5tbl", _fip, 0, tx_print_nul, motor_5.get_tbl_fn, motor_5.set_tbl_fn,  (float *)&motor_5, M5_TMC2130_TBL },
    { "5","5pgrd",_fip, 0, tx_print_nul, motor_5.get_pgrd_fn,motor_5.set_pgrd_fn, (float *)&motor_5, M5_TMC2130_PWM_GRAD },
    { "5","5pamp",_fip, 0, tx_print_nul, motor_5.get_pamp_fn,motor_5.set_pamp_fn, (float *)&motor_5, M5_TMC2130_PWM_AMPL },
    { "5","5hend",_fip, 0, tx_print_nul, motor_5.get_hend_fn,motor_5.set_hend_fn, (float *)&motor_5, M5_TMC2130_HEND },
    { "5","5hsrt",_fip, 0, tx_print_nul, motor_5.get_hsrt_fn,motor_5.set_hsrt_fn, (float *)&motor_5, M5_TMC2130_HSTRT },
    { "5","5smin",_fip, 0, tx_print_nul, motor_5.get_smin_fn,motor_5.set_smin_fn, (float *)&motor_5, M5_TMC2130_SMIN },
    { "5","5smax",_fip, 0, tx_print_nul, motor_5.get_smax_fn,motor_5.set_smax_fn, (float *)&motor_5, M5_TMC2130_SMAX },
    { "5","5sup", _fip, 0, tx_print_nul, motor_5.get_sup_fn, motor_5.set_sup_fn,  (float *)&motor_5, M5_TMC2130_SUP },
    { "5","5sdn", _fip, 0, tx_print_nul, motor_5.get_sdn_fn, motor_5.set_sdn_fn,  (float *)&motor_5, M5_TMC2130_SDN },
#endif
#endif
    ...
    { "6","6ts",  _f0,  0, tx_print_nul, motor_6.get_ts_fn,  set_ro,              (float *)&motor_6, 0 },
    { "6","6pth", _fip, 0, tx_print_nul, motor_6.get_pth_fn, motor_6.set_pth_fn,  (float *)&motor_6, M6_TMC2130_TPWMTHRS },
    { "6","6cth", _fip, 0, tx_print_nul, motor_6.get_cth_fn, motor_6.set_cth_fn,  (float *)&motor_6, M6_TMC2130_TCOOLTHRS },
    { "6","6hth", _fip, 0, tx_print_nul, motor_6.get_hth_fn, motor_6.set_hth_fn,  (float *)&motor_6, M6_TMC2130_THIGH },
    { "6","6sgt", _fip, 0, tx_print_nul, motor_6.get_sgt_fn, motor_6.set_sgt_fn,  (float *)&motor_6, M6_TMC2130_SGT },
    { "6","6sgr", _f0,  0, tx_print_nul, motor_6.get_sgr_fn, set_ro,              (float *)&motor_6, 0 },
    { "6","6csa", _f0,  0, tx_print_nul, motor_6.get_csa_fn, set_ro,              (float *)&motor_6, 0 },
    { "6","6sgs", _f0,  0, tx_print_nul, motor_6.get_sgs_fn, set_ro,              (float *)&motor_6, 0 },
    { "6","6tbl", _fip, 0, tx_print_nul, motor_6.get_tbl_fn, motor_6.set_tbl_fn,  (float *)&motor_6, M6_TMC2130_TBL },
    { "6","6pgrd",_fip, 0, tx_print_nul, motor_6.get_pgrd_fn,motor_6.set_pgrd_fn, (float *)&motor_6, M6_TMC2130_PWM_GRAD },
    { "6","6pamp",_fip, 0, tx_print_nul, motor_6.get_pamp_fn,motor_6.set_pamp_fn, (float *)&motor_6, M6_TMC2130_PWM_AMPL },
    { "6","6hend",_fip, 0, tx_print_nul, motor_6.get_hend_fn,motor_6.set_hend_fn, (float *)&motor_6, M6_TMC2130_HEND },
    { "6","6hsrt",_fip, 0, tx_print_nul, motor_6.get_hsrt_fn,motor_6.set_hsrt_fn, (float *)&motor_6, M6_TMC2130_HSTRT },
    { "6","6smin",_fip, 0, tx_print_nul, motor_6.get_smin_fn,motor_6.set_smin_fn, (float *)&motor_6, M6_TMC2130_SMIN },
    { "6","6smax",_fip, 0, tx_print_nul, motor_6.get_smax_fn,motor_6.set_smax_fn, (float *)&motor_6, M6_TMC2130_SMAX },
    { "6","6sup", _fip, 0, tx_print_nul, motor_6.get_sup_fn, motor_6.set_sup_fn,  (float *)&motor_6, M6_TMC2130_SUP },
    { "6","6sdn", _fip, 0, tx_print_nul, motor_6.get_sdn_fn, motor_6.set_sdn_fn,  (float *)&motor_6, M6_TMC2130_SDN },
#endif
#endif
