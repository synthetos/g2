...
#define INIT_MESSAGE "Initializing configs to Ender Laser settings"
...
#define JERK_MAX                    80000                 // 500 million mm/(min^3)
#define JERK_HIGH_SPEED             80000                // 1000 million mm/(min^3) // Jerk during homing needs to stop *fast*
#define VELOCITY_MAX                9000
#define LATCH_VELOCITY              5000                  // reeeeally slow for accuracy
