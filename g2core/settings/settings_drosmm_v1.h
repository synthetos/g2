...
// Not CoreXY like AxiDraw
//#define KINEMATICS KINE_CORE_XY                             // X and Y MUST use the same settings!

#if MOTORS == 3
// gQuadratic
#define X_Y_POWER_LEVEL 0.4
#define X_Y_MICROSTEPS 32
#define JERK_MAX    2000
#endif
#if MOTORS == 6
// gQuintic
#define X_Y_POWER_LEVEL 0.8
#define X_Y_MICROSTEPS 64
#define JERK_MAX    1000
#endif

#define M1_MOTOR_MAP                AXIS_X                  // 1ma
#define M1_STEP_ANGLE               1.8                     // 1sa
#define M1_TRAVEL_PER_REV           99.9                    // 1tr
#define M1_MICROSTEPS               X_Y_MICROSTEPS          // 1mi        1,2,4,8
#define M1_POLARITY                 0                       // 1po        0=normal, 1=reversed
#define M1_POWER_MODE               MOTOR_ALWAYS_POWERED    // 1pm        standard
#define M1_POWER_LEVEL              X_Y_POWER_LEVEL         // 1pl
