...
#define INIT_MESSAGE "Initializing configs to ISEL profile"
...
#define X_TRAVEL_MIN                -290                       // xtn  minimum travel for soft limits
