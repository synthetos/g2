/*
 * settings_liteplacer.h -Liteplacer pick and place support
...
#define INIT_MESSAGE "Initializing configs to Liteplacer Pick and Place settings"
...
#define STATUS_REPORT_DEFAULTS      "posx", "posy", "posz","stat", "coor", "momo", "dist","home", "vel", "plan", "line", "path","frmo", "hold", "macs", "cycs", "spc","prbe", "prs1", "feed","in1", "in3", "in5", "in6","ofsx", "ofsy", "ofsz","g55x", "g55y", "g55z"
...
#define MOTOR_POWER_LEVEL_XY        0.3               // default motor power level 0.00 - 1.00
...
#define M4_STEP_ANGLE               .9
#define M4_TRAVEL_PER_REV           160  // degrees moved per motor rev
#define M4_MICROSTEPS               8
#define M4_POLARITY                 1
#define M4_POWER_MODE               MOTOR_POWER_MODE
#define M4_POWER_LEVEL              MOTOR_POWER_LEVEL_XY
#define M4_POWER_LEVEL_IDLE         MOTOR_POWER_LEVEL_XY_IDLE
...
#define JERK_MAX                    5000                 // 500 million mm/(min^3)
#define JERK_HIGH_SPEED             20000                // 1000 million mm/(min^3) // Jerk during homing needs to stop *fast*
...
#define A_AXIS_MODE                 AXIS_RADIUS                                   // DISABLED
