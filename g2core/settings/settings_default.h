...
#define TTOFFSET(i)                                    \
    const float TT ## i ## _X_OFFSET = 0.0;            \
    const float TT ## i ## _Y_OFFSET = 0.0;            \
    const float TT ## i ## _Z_OFFSET = 0.0;            \
    const float TT ## i ## _U_OFFSET = 0.0;            \
    const float TT ## i ## _V_OFFSET = 0.0;            \
    const float TT ## i ## _W_OFFSET = 0.0;            \
    const float TT ## i ## _A_OFFSET = 0.0;            \
    const float TT ## i ## _B_OFFSET = 0.0;            \
    const float TT ## i ## _C_OFFSET = 0.0;
