/*
 * gquadratic-a-pinout.h - tinyg2 board pinout specification
...
#define OUTPUT1_PWM 0 // PWM1 - Fet 1
#define OUTPUT2_PWM 0 // PWM2 - Fet 2
#define OUTPUT3_PWM 0 // PWM3 - Fan 1
#define OUTPUT4_PWM 0 // PWM2 - Fan 2
#define OUTPUT5_PWM 0 // Timer2ch0 - Fan 3
#define OUTPUT6_PWM 0 // Timer2ch1
#define OUTPUT7_PWM 0 // PWM2
#define OUTPUT8_PWM 0 // PWM0
...
namespace Motate {
    ...
    _MAKE_MOTATE_PIN(kSerial_RTS                    , 'A', 28); //
    _MAKE_MOTATE_PIN(kUnassigned18                  , 'A', 29); // Missing in 100-pin package
    _MAKE_MOTATE_PIN(kUnassigned19                  , 'A', 30); // INTERRUPT_OUT
    _MAKE_MOTATE_PIN(kSerial_CTS                    , 'A', 31); //
    ...
    _MAKE_MOTATE_PIN(kOutputSAFE_PinNumber          , 'D',  3); //
    _MAKE_MOTATE_PIN(kUnassigned24                  , 'D',  4); //
    _MAKE_MOTATE_PIN(kUnassigned25                  , 'D',  5); //
    _MAKE_MOTATE_PIN(kUnassigned26                  , 'D',  6); //
    _MAKE_MOTATE_PIN(kInput3_PinNumber              , 'D',  7); //
    _MAKE_MOTATE_PIN(kInput4_PinNumber              , 'D',  8); // DIAG1
