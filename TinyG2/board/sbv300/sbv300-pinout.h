...
namespace Motate {
    ...
    _MAKE_MOTATE_PIN(kUnassigned5               , 'A',  5);
    _MAKE_MOTATE_PIN(kUnassigned6               , 'A',  6);
    _MAKE_MOTATE_PIN(kUnassigned7               , 'A',  7);
    _MAKE_MOTATE_PIN(kUnassigned8               , 'A',  8);
    _MAKE_MOTATE_PIN(kUnassigned9               , 'A',  9);
    _MAKE_MOTATE_PIN(kUnassigned10              , 'A', 10);
    _MAKE_MOTATE_PIN(kUnassigned11              , 'A', 11);
    _MAKE_MOTATE_PIN(kUnassigned12              , 'A', 12);
    _MAKE_MOTATE_PIN(kUnassigned13              , 'A', 13);
    _MAKE_MOTATE_PIN(kUnassigned14              , 'A', 14);
    _MAKE_MOTATE_PIN(kUnassigned15              , 'A', 15);
    _MAKE_MOTATE_PIN(kUnassigned16              , 'A', 16);
    _MAKE_MOTATE_PIN(kUnassigned17              , 'A', 17);
    ...
    _MAKE_MOTATE_PIN(kUnassigned31              , 'B',  3);
    _MAKE_MOTATE_PIN(kUnassigned32              , 'B',  4);
    _MAKE_MOTATE_PIN(kUnassigned33              , 'B',  5);
    _MAKE_MOTATE_PIN(kUnassigned34              , 'B',  6);
    _MAKE_MOTATE_PIN(kUnassigned35              , 'B',  7);
    _MAKE_MOTATE_PIN(kUnassigned36              , 'B',  8);
    _MAKE_MOTATE_PIN(kUnassigned37              , 'B',  9);
    ...
    _MAKE_MOTATE_PIN(kUnassigned63              , 'C',  9);
    _MAKE_MOTATE_PIN(kInput1_PinNumber          , 'C', 10);
    ...
    _MAKE_MOTATE_PIN(kSpindle_DirPinNumber      , 'D',  7);
    _MAKE_MOTATE_PIN(kUnassigned79              , 'D',  8);
