/*
 * printrbaordG2v3-pinout.h - tinyg2 board pinout specification
...
namespace Motate {
    ...
    _MAKE_MOTATE_PIN(kUnassigned1                       , A, 'A',  0);  // nc
    _MAKE_MOTATE_PIN(kUnassigned2                       , A, 'A',  1);  // nc
    _MAKE_MOTATE_PIN(kSocket4_VrefPinNumber             , A, 'A',  2);  // M4_Vref
    ...
    _MAKE_MOTATE_PIN(kUnassigned4                       , A, 'A', 12);  // USART_RX (not used)
    _MAKE_MOTATE_PIN(kUnassigned5                       , A, 'A', 13);  // USART_TX (not used)
    _MAKE_MOTATE_PIN(kSerial_RTS                        , A, 'A', 14);  // UART_RTS
    _MAKE_MOTATE_PIN(kSerial_CTS                        , A, 'A', 15);  // UART_CTS
    _MAKE_MOTATE_PIN(kSocket1_DirPinNumber              , A, 'A', 16);  // M1_DIR
    _MAKE_MOTATE_PIN(kUnassigned6                       , A, 'A', 17);  // nc
    _MAKE_MOTATE_PIN(kSocket1_InterruptPinNumber        , A, 'A', 18);  // INTERRUPT_OUT
    _MAKE_MOTATE_PIN(kSocket1_Microstep_2PinNumber      , A, 'A', 19);  // M1_MS2
    _MAKE_MOTATE_PIN(kSocket1_Microstep_0PinNumber      , A, 'A', 20);  // M1_MS0 (M1_MS1 is slaved to this signal also)
    _MAKE_MOTATE_PIN(kSocket2_StepPinNumber             , A, 'A', 21);  // M2_STEP
    _MAKE_MOTATE_PIN(kUnassigned7                       , A, 'A', 22);  // <reserved for filament sensor digital in or ADC>
    _MAKE_MOTATE_PIN(kADC1_PinNumber                    , A, 'A', 23);  // EX1_ADC (Extruder1 ADC)
    _MAKE_MOTATE_PIN(kUnassigned8                       , A, 'A', 24);  // nc
    _MAKE_MOTATE_PIN(kSocket2_EnablePinNumber           , A, 'A', 25);  // M2_ENABLE
    _MAKE_MOTATE_PIN(kSocket2_DirPinNumber              , A, 'A', 26);  // M2_DIR
    _MAKE_MOTATE_PIN(kSocket3_Microstep_2PinNumber      , A, 'A', 27);  // M3_MS2
    _MAKE_MOTATE_PIN(kSocket3_Microstep_0PinNumber      , A, 'A', 28);  // M3_MS0 (M3_MS1 is slaved to this signal also)
    _MAKE_MOTATE_PIN(kSocket3_StepPinNumber             , A, 'A', 29);  // M3_STEP

    _MAKE_MOTATE_PIN(kSocket3_EnablePinNumber           , B, 'B',  0);  // M3_ENABLE
    _MAKE_MOTATE_PIN(kSocket3_DirPinNumber              , B, 'B',  1);  // M3_DIR
    _MAKE_MOTATE_PIN(kUnassigned9                       , B, 'B',  2);  // nc
    _MAKE_MOTATE_PIN(kOutput12_PinNumber                , B, 'B',  3);  // DO_12 (INDICATOR_LED)
    _MAKE_MOTATE_PIN(kUnassigned10                      , B, 'B',  4);  // nc
    _MAKE_MOTATE_PIN(kUnassigned11                      , B, 'B',  5);  // nc
    _MAKE_MOTATE_PIN(kUnassigned12                      , B, 'B',  6);  // nc
    _MAKE_MOTATE_PIN(kUnassigned13                      , B, 'B',  7);  // nc
    _MAKE_MOTATE_PIN(kUnassigned14                      , B, 'B',  8);  // nc
    ...
    _MAKE_MOTATE_PIN(kSocket1_VrefPinNumber             , B, 'B', 17);  // M1_Vref 
    _MAKE_MOTATE_PIN(kSocket2_VrefPinNumber             , B, 'B', 18);  // M2_Vref 
    _MAKE_MOTATE_PIN(kSocket3_VrefPinNumber             , B, 'B', 19);  // M3_Vref 
    _MAKE_MOTATE_PIN(kSocket2_Microstep_2PinNumber      , B, 'B', 20);  // M2_MS2
    _MAKE_MOTATE_PIN(kSocket2_Microstep_0PinNumber      , B, 'B', 21);  // M2_MS0 (M2_MS1 is slaved to this signal also)
    _MAKE_MOTATE_PIN(kSocket4_EnablePinNumber           , B, 'B', 22);  // M4_ENABLE
    _MAKE_MOTATE_PIN(kSocket4_DirPinNumber              , B, 'B', 23);  // M4_DIR
