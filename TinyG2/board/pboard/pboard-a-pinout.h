...
namespace Motate {
    ...
    _MAKE_MOTATE_PIN(kUnused_0              ,   A, 'A', 11); // ???
    ...
    _MAKE_MOTATE_PIN(kUnused_1              ,   A, 'A', 18); // ???
    _MAKE_MOTATE_PIN(kUnused_2              ,   A, 'A', 19); // ???
    ...
    _MAKE_MOTATE_PIN(kUnused_5, B, 'B', 30);  // JTAG_TDO
    _MAKE_MOTATE_PIN(kUnused_6, B, 'B', 31);  // JTAG_TMS / SWD_DIO
