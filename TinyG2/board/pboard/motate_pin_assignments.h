...
namespace Motate {
    ...
    pin_number kADC4_PinNumber                  = 154;   // Not physially pinned out
    pin_number kADC5_PinNumber                  = 155;   // Not physially pinned out
    pin_number kADC6_PinNumber                  = 156;   // Not physially pinned out
    pin_number kADC7_PinNumber                  = 157;   // Not physially pinned out
    pin_number kADC8_PinNumber                  = 158;   // Not physially pinned out
    pin_number kADC9_PinNumber                  = 159;   // Not physially pinned out
    pin_number kADC10_PinNumber                 = 160;   // Not physially pinned out
    pin_number kADC11_PinNumber                 = 161;   // Not physially pinned out
    pin_number kADC12_PinNumber                 = 162;   // Not physially pinned out
