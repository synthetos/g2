...
#define X_JERK_MAX				((float)5000000000)	// xjm		yes, that's "5 billion" mm/(min^3)
...
#define X_JERK_HOMING			((float)10000000000)// xjh

#define Y_AXIS_MODE				AXIS_STANDARD
#define Y_VELOCITY_MAX			16000
#define Y_FEEDRATE_MAX			Y_VELOCITY_MAX
#define Y_TRAVEL_MAX			220
#define Y_JERK_MAX				((float)5000000000)	// 5,000,000,000
...
#define Y_JERK_HOMING			((float)10000000000)

#define Z_AXIS_MODE				AXIS_STANDARD
#define Z_VELOCITY_MAX			800
#define Z_FEEDRATE_MAX			Z_VELOCITY_MAX
#define Z_TRAVEL_MAX			100
#define Z_JERK_MAX				((float)50000000)	// 50,000,000
...
#define B_JERK_MAX				((float)20000000)
...
#define C_JERK_MAX				((float)20000000)
