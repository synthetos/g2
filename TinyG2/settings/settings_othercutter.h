...
#define M2_POWER_MODE			MOTOR_POWERED_IN_CYCLE	// hold
...
#define M3_POWER_MODE 			MOTOR_POWERED_IN_CYCLE			// z-axis leadscrew doesn't need hold, enable low power idle
...
#define M4_POWER_MODE 			MOTOR_POWERED_IN_CYCLE			// hold
...
#define X_TRAVEL_MAX 			320					// xtm		maximum travel - used by soft limits and homing
...
#define Y_TRAVEL_MIN 			-1					// Y-axis is infinite
...
// B and C rotary values are chosen to make the motors react the same as X for testing
