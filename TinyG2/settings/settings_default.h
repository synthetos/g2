...
#ifndef JUNCTION_AGGRESSION
#define JUNCTION_AGGRESSION         0.75    // {ja: cornering - between 0.05 and 2.00 (max)
#endif
...
#ifndef BLOCK_COMPRESSION_ENABLE
#define BLOCK_COMPRESSION_ENABLE    1       // {bce: 0=off, 1=on
#endif
...
#ifndef XIO_EXPAND_CR
#define XIO_EXPAND_CR               false                   // {ec: (AVR ONLY)
#endif

#ifndef XIO_ENABLE_ECHO
#define XIO_ENABLE_ECHO             false                   // {ee: (AVR ONLY)
#endif

#ifndef XIO_ENABLE_FLOW_CONTROL
#define XIO_ENABLE_FLOW_CONTROL     FLOW_CONTROL_RTS        // {ex: (AVR ONLY) FLOW_CONTROL_OFF, FLOW_CONTROL_XON, FLOW_CONTROL_RTS
#endif
