...
#define MOTOR_POWER_LEVEL_XY        0.500                   // default motor power level 0.00 - 1.00 (ARM only)
#define MOTOR_POWER_LEVEL_Z         0.750                   // default motor power level 0.00 - 1.00 (ARM only)
...
// Zmin
#define DI5_MODE                    IO_ACTIVE_LOW    // Z proble
