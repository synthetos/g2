...
#define SWITCH_TYPE					SW_TYPE_NORMALLY_OPEN	// SW_TYPE_NORMALLY_CLOSED
...
//#define JSON_VERBOSITY				JV_MESSAGES		// one of: JV_SILENT, JV_FOOTER, JV_CONFIGS, JV_MESSAGES, JV_LINENUM, JV_VERBOSE, JV_EXCEPTIONS
