...
//	{ "", "boot",_f00, 0, tx_print_nul, help_boot_loader,hw_run_boot, (float *)&cs.null,0 },
	...
	{ "1","1mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_1].power_level,	0.5 },		
#if (MOTORS >= 2)
	...
	{ "2","2mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_2].power_level,	0.5 },
#endif
#if (MOTORS >= 3)
	...
	{ "3","3mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_3].power_level,	0.5 },
#endif
#if (MOTORS >= 4)
	...
	{ "4","4mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_4].power_level,	0.5 },
#endif
#if (MOTORS >= 5)
	...
	{ "5","5mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_5].power_level,	0.5 },
#endif
#if (MOTORS >= 6)
	...
	{ "6","6mp",_fip, 3, st_print_mp, get_flt, st_set_mp, (float *)&st.m[MOTOR_6].power_level,	0.5 },
#endif
