...
//	{ "c","cjd",_fipc, 4, cm_print_jd, get_nul,   set_nul,   (float *)&cs.null, 0 },                // DEPRECATED
    ...
    { "he1","he1st",_f0,  0, tx_print_nul, cm_get_set_temperature, cm_set_set_temperature, (float *)&cs.null, 0 },
	...
	{ "sys","bme",_fipn, 0, cm_print_bme, get_ui8, set_01,   (float *)&mb.block_merge_enable,       BLOCK_MERGE_ENABLE },
	{ "sys","bmr",_fipn, 0, cm_print_bmr, get_flt, set_nul,  (float *)&mb.block_merge_ratio,  0 },
	{ "sys","bmv",_fipn, 0, cm_print_bmv, get_flt, set_flt,  (float *)&mb.block_merge_velocity_max, BLOCK_MERGE_VELOCITY_MAX },
	{ "sys","bml",_fipn, 2, cm_print_bml, get_flt, set_flt,  (float *)&mb.block_merge_length_max,   BLOCK_MERGE_LENGTH_MAX },
	{ "sys","bmc",_fipn, 2, cm_print_bmc, get_flt, set_flt,  (float *)&mb.block_merge_cosine_min,   BLOCK_MERGE_COSINE_MIN },
