...
//	{ "", "test",_f00, 0, tx_print_nul, help_test, run_test, (float *)&cs.null,0 },	// run tests, print test help screen
	...
	{ "1","1pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_1].power_level,M1_POWER_LEVEL },		
#if (MOTORS >= 2)
	...
	{ "2","2pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_2].power_level,M2_POWER_LEVEL},
#endif
#if (MOTORS >= 3)
	...
	{ "3","3pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_3].power_level,M3_POWER_LEVEL },
#endif
#if (MOTORS >= 4)
	...
	{ "4","4pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_4].power_level,M4_POWER_LEVEL },
#endif
#if (MOTORS >= 5)
	...
	{ "5","5pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_5].power_level,M5_POWER_LEVEL },
#endif
#if (MOTORS >= 6)
	...
	{ "6","6pl",_fip, 2, st_print_pl, get_flt, st_set_pl, (float *)&st_cfg.mot[MOTOR_6].power_level,M6_POWER_LEVEL },
#endif
