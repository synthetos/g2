...
struct StepDirStepper : Stepper {
	...
	void setMicrosteps(const uint8_t microsteps) override
	{
        if (!_enable.isNull()) {
            switch (microsteps) {
                case ( 1): { _ms2=0; _ms1=0; _ms0=0; break; }
                case ( 2): { _ms2=0; _ms1=0; _ms0=1; break; }
                case ( 4): { _ms2=0; _ms1=1; _ms0=0; break; }
                case ( 8): { _ms2=0; _ms1=1; _ms0=1; break; }
                case (16): { _ms2=1; _ms1=0; _ms0=0; break; }
                case (32): { _ms2=1; _ms1=0; _ms0=1; break; }
            }
        }
	};
